export default function Home() {
  return (
    <main className="min-h-screen bg-slate-50 text-slate-800 antialiased">
      ...
      <header className="bg-white border-b sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <nav className="flex gap-6 font-medium text-slate-600">
            ...
            <a href="#blogs" className="hover:text-amber-600 transition">Safety Blogs</a>
          </nav>
      ...
      {/* Hero Section with High SEO Focus */}
      <section className="relative bg-slate-900 text-white py-24 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="https://wa.me/971501234567" className="bg-transparent border border-slate-700 hover:border-slate-500 text-white px-8 py-3.5 rounded-lg font-bold transition">
      ...
      {/* Products Category Grid Preview */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
              <span className="text-xs font-bold text-amber-600 uppercase">Traffic Safety</span>
              <h4 className="text-lg font-bold text-slate-900 mt-1 mb-3">Traffic Post & Cones</h4>
              <p className="text-xs text-slate-500 mb-4">High-visibility reflective traffic safety cones, warning lights, and automatic parking locks.</p>
              <a href="/blog/traffic-safety-supplier-abu-dhabi" className="text-sm font-bold text-slate-900 hover:text-amber-600 inline-flex items-center gap-1">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
              ...
              <a href="/blog/ppe-wholesale-abu-dhabi" className="text-sm font-bold text-slate-900 hover:text-amber-600 inline-flex items-center gap-1">
                Read SEO Buying Guide &rarr;
              </a>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
              ...
              <a href="/blog/first-aid-box-supplier-abu-dhabi" className="text-sm font-bold text-slate-900 hover:text-amber-600 inline-flex items-center gap-1">
                Read SEO Buying Guide &rarr;
              </a>
            </div>
          </div>
